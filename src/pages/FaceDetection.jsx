    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="relative z-10 overflow-hidden">
        <div className="relative max-w-6xl mx-auto px-5 sm:px-6 pt-28 sm:pt-32 pb-6">
          ...
          <h1 className="font-poppins font-black text-3xl sm:text-5xl md:text-6xl text-white leading-tight pb-1 mb-2">
            Vision AI
          </h1>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-6 pb-24">
          ...
          {TOOLS.map(t => {
            ...
            return (
              <button
                ...
                className={`group relative p-3 sm:p-4 rounded-lg text-left transition-colors border luxe-card luxe-card-hover ${
                  isActive
                    ? `${t.border} bg-gray-900`
                    : 'border-gray-800 hover:bg-gray-900 hover:border-gray-700'
                }`}>
                <div className={`mb-2 inline-flex items-center justify-center w-9 h-9 rounded-lg ${t.accent} text-black/80`}>
                  {t.icon}
                </div>
                ...
                {isActive && (
                  <div className={`absolute -top-1 -right-1 w-3 h-3 rounded-full ${t.accent} ring-2 ring-gray-950`} />
                )}
              </button>
            )
          })}
        ...
        <div className="flex items-center gap-3 mb-5">
          <div className={`w-1 h-8 rounded-lg ${active.accent}`} />
          <div>
