// Nine Men's Morris — placeholder. The real implementation ships in the
...
export default function NineMensMorris() {
  return (
    <GameShell title="Nine Men's Morris" category="Board" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Nine Men's Morris">⚪</div>
        <div className="text-white/80 font-semibold text-lg">Nine Men's Morris</div>
        <div className="text-sm max-w-md">Form mills (3 in a row) to remove opponent pieces.</div>
