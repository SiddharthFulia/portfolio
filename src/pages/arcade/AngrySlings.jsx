// Angry Slings — placeholder. The real implementation ships in the
...
export default function AngrySlings() {
  return (
    <GameShell title="Angry Slings" category="Physics" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Angry Slings">🪃</div>
        <div className="text-white/80 font-semibold text-lg">Angry Slings</div>
        <div className="text-sm max-w-md">Slingshot projectiles at towers. Physics chain reactions.</div>
