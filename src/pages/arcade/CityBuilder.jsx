// City Builder — placeholder. The real implementation ships in the
...
export default function CityBuilder() {
  return (
    <GameShell title="City Builder" category="Strategy" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="City Builder">🏙️</div>
        <div className="text-white/80 font-semibold text-lg">City Builder</div>
        <div className="text-sm max-w-md">Zone, tax, watch neighbourhoods evolve.</div>
