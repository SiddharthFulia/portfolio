// Line Rider — placeholder. The real implementation ships in the
...
export default function LineRider() {
  return (
    <GameShell title="Line Rider" category="Physics" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Line Rider">🛷</div>
        <div className="text-white/80 font-semibold text-lg">Line Rider</div>
        <div className="text-sm max-w-md">Draw a track. Sledder rides it.</div>
