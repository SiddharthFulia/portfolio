// Mini RTS — placeholder. The real implementation ships in the
...
export default function MiniRts() {
  return (
    <GameShell title="Mini RTS" category="Strategy" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Mini RTS">⚔️</div>
        <div className="text-white/80 font-semibold text-lg">Mini RTS</div>
        <div className="text-sm max-w-md">Gather, build, command squads. Fog of war.</div>
