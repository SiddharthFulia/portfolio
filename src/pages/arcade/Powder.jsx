// Powder Game — placeholder. The real implementation ships in the
...
export default function Powder() {
  return (
    <GameShell title="Powder Game" category="Sim" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Powder Game">🏖️</div>
        <div className="text-white/80 font-semibold text-lg">Powder Game</div>
        <div className="text-sm max-w-md">Falling-sand sim. Sand, water, fire, salt, plant.</div>
