// 2048 — placeholder. The real implementation ships in the
...
export default function Twenty48() {
  return (
    <GameShell title="2048" category="Puzzle" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="2048">🎯</div>
        <div className="text-white/80 font-semibold text-lg">2048</div>
        <div className="text-sm max-w-md">Slide tiles, merge equal numbers, reach 2048.</div>
