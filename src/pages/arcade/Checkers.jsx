// Checkers — placeholder. The real implementation ships in the
...
export default function Checkers() {
  return (
    <GameShell title="Checkers" category="Board" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Checkers">⬛</div>
        <div className="text-white/80 font-semibold text-lg">Checkers</div>
        <div className="text-sm max-w-md">Jump captures. Kings move both ways.</div>
