// Tempest — placeholder. The real implementation ships in the
...
export default function Tempest() {
  return (
    <GameShell title="Tempest" category="Retro" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Tempest">🕳️</div>
        <div className="text-white/80 font-semibold text-lg">Tempest</div>
        <div className="text-sm max-w-md">Vector-graphics wireframe tunnel. Blast enemies climbing up.</div>
