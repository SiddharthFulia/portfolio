// Chinese Checkers — placeholder. The real implementation ships in the
...
export default function ChineseCheckers() {
  return (
    <GameShell title="Chinese Checkers" category="Board" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Chinese Checkers">⭐</div>
        <div className="text-white/80 font-semibold text-lg">Chinese Checkers</div>
        <div className="text-sm max-w-md">Race pieces across the star board.</div>
