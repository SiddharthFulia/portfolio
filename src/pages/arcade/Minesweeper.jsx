// Minesweeper — placeholder. The real implementation ships in the
...
export default function Minesweeper() {
  return (
    <GameShell title="Minesweeper" category="Puzzle" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Minesweeper">💣</div>
        <div className="text-white/80 font-semibold text-lg">Minesweeper</div>
        <div className="text-sm max-w-md">Flag mines by deducing from number hints.</div>
