// Reaction Test — placeholder. The real implementation ships in the
...
export default function Reaction() {
  return (
    <GameShell title="Reaction Test" category="Reflex" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Reaction Test">⚡</div>
        <div className="text-white/80 font-semibold text-lg">Reaction Test</div>
        <div className="text-sm max-w-md">Wait for green. Tap as fast as possible.</div>
