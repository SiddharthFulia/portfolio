// Space Invaders — placeholder. The real implementation ships in the
...
export default function SpaceInvaders() {
  return (
    <GameShell title="Space Invaders" category="Arcade" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Space Invaders">👾</div>
        <div className="text-white/80 font-semibold text-lg">Space Invaders</div>
        <div className="text-sm max-w-md">Alien waves descend. You have a laser cannon.</div>
