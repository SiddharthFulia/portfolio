// Idle Miner — placeholder. The real implementation ships in the
...
export default function IdleMiner() {
  return (
    <GameShell title="Idle Miner" category="Sim" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Idle Miner">⛏️</div>
        <div className="text-white/80 font-semibold text-lg">Idle Miner</div>
        <div className="text-sm max-w-md">Auto-mine, buy upgrades, prestige.</div>
