// Bullet Hell — placeholder. The real implementation ships in the
...
export default function BulletHell() {
  return (
    <GameShell title="Bullet Hell" category="Reflex" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Bullet Hell">🌸</div>
        <div className="text-white/80 font-semibold text-lg">Bullet Hell</div>
        <div className="text-sm max-w-md">Weave through hundreds of projectiles.</div>
