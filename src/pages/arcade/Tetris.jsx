// Tetris — placeholder. The real implementation ships in the
...
export default function Tetris() {
  return (
    <GameShell title="Tetris" category="Puzzle" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Tetris">🟦</div>
        <div className="text-white/80 font-semibold text-lg">Tetris</div>
        <div className="text-sm max-w-md">Rotate tetrominoes to fill lines.</div>
