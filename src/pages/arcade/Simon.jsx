// Simon — placeholder. The real implementation ships in the
...
export default function Simon() {
  return (
    <GameShell title="Simon" category="Reflex" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Simon">🎨</div>
        <div className="text-white/80 font-semibold text-lg">Simon</div>
        <div className="text-sm max-w-md">Repeat the growing colour sequence.</div>
