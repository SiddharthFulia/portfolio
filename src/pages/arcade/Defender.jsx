// Defender — placeholder. The real implementation ships in the
...
export default function Defender() {
  return (
    <GameShell title="Defender" category="Retro" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Defender">🛸</div>
        <div className="text-white/80 font-semibold text-lg">Defender</div>
        <div className="text-sm max-w-md">Rescue humans from abductors on a scrolling planet.</div>
