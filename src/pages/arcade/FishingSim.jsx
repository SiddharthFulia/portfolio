// Fishing Sim — placeholder. The real implementation ships in the
...
export default function FishingSim() {
  return (
    <GameShell title="Fishing Sim" category="Sim" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Fishing Sim">🎣</div>
        <div className="text-white/80 font-semibold text-lg">Fishing Sim</div>
        <div className="text-sm max-w-md">Cast, hook, reel. Depth-based species.</div>
