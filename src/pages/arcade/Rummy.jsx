// Gin Rummy — placeholder. The real implementation ships in the
...
export default function Rummy() {
  return (
    <GameShell title="Gin Rummy" category="Card" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Gin Rummy">♣️</div>
        <div className="text-white/80 font-semibold text-lg">Gin Rummy</div>
        <div className="text-sm max-w-md">Form melds of 3+ cards. Knock on ≤ 10 deadwood.</div>
