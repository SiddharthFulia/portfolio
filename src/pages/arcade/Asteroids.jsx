// Asteroids — placeholder. The real implementation ships in the
...
export default function Asteroids() {
  return (
    <GameShell title="Asteroids" category="Arcade" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Asteroids">🌑</div>
        <div className="text-white/80 font-semibold text-lg">Asteroids</div>
        <div className="text-sm max-w-md">Rotate, thrust, shoot the rocks. Beware the saucer.</div>
