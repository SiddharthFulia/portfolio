// Whack-a-Mole — placeholder. The real implementation ships in the
...
export default function Whack() {
  return (
    <GameShell title="Whack-a-Mole" category="Reflex" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Whack-a-Mole">🔨</div>
        <div className="text-white/80 font-semibold text-lg">Whack-a-Mole</div>
        <div className="text-sm max-w-md">Tap the moles as they pop up.</div>
