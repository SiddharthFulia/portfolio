// Farming Sim — placeholder. The real implementation ships in the
...
export default function FarmingSim() {
  return (
    <GameShell title="Farming Sim" category="Sim" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Farming Sim">🌾</div>
        <div className="text-white/80 font-semibold text-lg">Farming Sim</div>
        <div className="text-sm max-w-md">Plant, water, harvest, sell. Seasons cycle.</div>
