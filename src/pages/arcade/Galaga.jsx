// Galaga — placeholder. The real implementation ships in the
...
export default function Galaga() {
  return (
    <GameShell title="Galaga" category="Retro" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Galaga">🚀</div>
        <div className="text-white/80 font-semibold text-lg">Galaga</div>
        <div className="text-sm max-w-md">Vertical scroller. Formation attacks. Rescue captured ships for double firepower.</div>
