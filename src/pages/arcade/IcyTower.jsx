// Icy Tower — placeholder. The real implementation ships in the
...
export default function IcyTower() {
  return (
    <GameShell title="Icy Tower" category="Runner" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Icy Tower">🧊</div>
        <div className="text-white/80 font-semibold text-lg">Icy Tower</div>
        <div className="text-sm max-w-md">Climb by chaining wall jumps. Screen scrolls up faster over time.</div>
