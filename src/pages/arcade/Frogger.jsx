// Frogger — placeholder. The real implementation ships in the
...
export default function Frogger() {
  return (
    <GameShell title="Frogger" category="Arcade" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Frogger">🐸</div>
        <div className="text-white/80 font-semibold text-lg">Frogger</div>
        <div className="text-sm max-w-md">Cross a road and a river without getting flattened.</div>
