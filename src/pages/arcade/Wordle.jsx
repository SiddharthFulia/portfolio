// Wordle — placeholder. The real implementation ships in the
...
export default function Wordle() {
  return (
    <GameShell title="Wordle" category="Puzzle" status="idle">
      <div className="p-8 text-center min-h-[50vh] flex flex-col items-center justify-center gap-3 text-white/50">
        <div className="text-6xl select-none" role="img" aria-label="Wordle">🔤</div>
        <div className="text-white/80 font-semibold text-lg">Wordle</div>
        <div className="text-sm max-w-md">5-letter guess. Green = right spot, yellow = wrong spot.</div>
