...
// Home — the cinematic hero plays scroll-driven (page itself is
// locked while video plays). Once it ends, body scroll unlocks
// and the visitor can drop into the full-stack section below.
const Home = () => {
  ...
  return (
    <>
      ...
      <section
        id="below"
        className="luxe-stage relative w-full overflow-hidden flex items-center py-24 scroll-mt-20"
      >
