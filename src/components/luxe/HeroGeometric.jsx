// Adapted from 21st.dev's "shape-landing-hero" / Kokonut UI to JSX.
// Renders a full-bleed dark hero with slow-drifting elegant capsule
// shapes behind the title. Use as a high-impact landing section.
//
// Props (all optional):
//   badge   — small pill above the title
//   title1  — first heading line (white)
//   title2  — second heading line (indigo→rose gradient)
//   subtitle
//   children — optional CTAs / extra content rendered below the subtitle
...
export default function HeroGeometric({
  badge = 'Sid · Portfolio',
  title1 = 'Builder · creator',
  title2 = 'shipping ideas as code',
  subtitle = 'Full-stack engineering, generative AI, and the occasional pixel-perfect landing page.',
  children,
}) {
  return (
